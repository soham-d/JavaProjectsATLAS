...
public class RouteService {
	...
	public void viewRoutes() {
		...
		System.out.println("Listing all route names & IDs");
	...
	public void requestRouteVisitor() {
		Feedback feedback = new Feedback();
		feedback.getDetailsVisitor();
		int id = 8;					   // Id for Visitor
		String email = "visitor@test.com"; // Email for Visitor
		feedback.title = "Route Request";
		feedback.userId = id;
		feedback.raisedBy = email;
		
		int result = feedbackDAO.insert(feedback);
		String message = (result > 0) ? "Request Created Successfully" : "Creating request Failed. Try Again.."; 
		System.out.println(message);
	}
