...
public class DB {
	...
	public static String URL = "jdbc:sqlserver://localhost:1433; databaseName=dmat;integratedSecurity=false; encrypt=true;trustServerCertificate=true";
	public static String USER = "java2";
	public static String PASSWORD = "java";
	
	public static float STTPercentage = (float) 0.001; //  STT = 0.1%
	public static float TransactionCharges = (float) 0.005; // Txn Chrages = 0.5%

	
	//String url = "jdbc:sqlserver://localhost:1433; databaseName=dmat; user=java2;password=java; integratedSecurity=false; encrypt=true;trustServerCertificate=true";
...
//			System.out.println("[DB] Connection Created Successfully....");
			...
			// MS-SQL
			String url = "jdbc:sqlserver://localhost:1433; databaseName=dmat;integratedSecurity=false; encrypt=true;trustServerCertificate=true";
			connection = DriverManager.getConnection(url, USER, PASSWORD);
			System.out.println("[DB] Connection Created Successfully....");
